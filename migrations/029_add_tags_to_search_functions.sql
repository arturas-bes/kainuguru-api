...
-- Update hybrid_search_products to support tag filtering
...
BEGIN
    ...
    WITH fts_results AS (
        ...
        WHERE
            ...
            AND (tag_filters IS NULL OR p.tags && tag_filters)  -- Array overlap operator
    ),
    trigram_results AS (
        SELECT
            p.id,
...
-- Update fuzzy_search_products to support tag filtering
...
-- Restore functions without tag filtering
